...
public class RestaurentFoodAdapter extends RecyclerView.Adapter<RestaurentFoodAdapter.ViewHolder> {
    private Context ctx;
    ...
    public RestaurentFoodAdapter(Context context, ArrayList<Result> list) {
        mlist = list;
        ctx = context;
